...
<el-container>
  ...
  <el-button  round style="color :green" @click="handleAdd">添加</el-button>
       ...
       <el-table :data="tableData" >
          ...
          <el-table-column prop="place" label="交易地点" width="250">
          </el-table-column>
           <el-table-column prop="fineness" label="成色" width="250">
          </el-table-column>
...
export default {
 ...
 mounted() 
{
    axios.get("http://localhost:8081/mygoods/").then((result) => {
